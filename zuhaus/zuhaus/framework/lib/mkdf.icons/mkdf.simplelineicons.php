...
class ZuhausMikadoSimpleLineIcons implements iZuhausMikadoIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'zuhaus'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'zuhaus'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'zuhaus'),
            'icon-social-facebook'    => esc_html__('Facebook', 'zuhaus'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'zuhaus'),
            'icon-social-github'      => esc_html__('Github', 'zuhaus'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'zuhaus'),
            'icon-social-instagram'   => esc_html__('Instagram', 'zuhaus'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'zuhaus'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'zuhaus'),
            'icon-social-reddit'      => esc_html__('Reddit', 'zuhaus'),
            'icon-social-skype'       => esc_html__('Skype', 'zuhaus'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'zuhaus'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'zuhaus'),
            'icon-social-spotify'     => esc_html__('Spotify', 'zuhaus'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'zuhaus'),
            'icon-social-twitter'     => esc_html__('Twitter', 'zuhaus'),
            'icon-social-youtube'     => esc_html__('Youtube', 'zuhaus')
        );
    }
