        ...
        <div class="mkdf-post-text">
            <div class="mkdf-post-text-inner">
                ...
                <div class="mkdf-post-text-main">
                    ...
                    <?php zuhaus_mikado_get_module_template_part('templates/parts/excerpt', 'blog', '', $part_params); ?>
                    <?php do_action('zuhaus_mikado_single_link_pages'); ?>
                    <?php zuhaus_mikado_get_module_template_part('templates/parts/post-info/read-more', 'blog', '', $part_params); ?>
                </div>
