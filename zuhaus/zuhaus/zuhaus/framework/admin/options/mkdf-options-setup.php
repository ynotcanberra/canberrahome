...
if ( ! function_exists( 'zuhaus_mikado_admin_map_init' ) ) {
	function zuhaus_mikado_admin_map_init() {
		do_action( 'zuhaus_mikado_before_options_map' );
		...
		do_action( 'zuhaus_mikado_options_map' );
		
		do_action( 'zuhaus_mikado_after_options_map' );
	}
	
	add_action( 'after_setup_theme', 'zuhaus_mikado_admin_map_init', 1 );
}