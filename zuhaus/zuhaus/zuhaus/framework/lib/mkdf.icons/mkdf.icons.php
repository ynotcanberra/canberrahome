...
/*
  Class: ZuhausMikadoIconCollections
...
class ZuhausMikadoIconCollections
{
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new ZuhausMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new ZuhausMikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new ZuhausMikadoIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new ZuhausMikadoLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('linear_icons', new ZuhausMikadoLinearIcons('Linear Icons', 'linear_icon'));
        $this->addIconCollection('simple_line_icons', new ZuhausMikadoSimpleLineIcons('Simple Line Icons', 'simple_line_icon'));
        $this->addIconCollection('dripicons', new ZuhausMikadoDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconsMetaBoxOrOption($attributes) {
        ...
        $options = array(
            'font_awesome'      => esc_html__('Font Awesome', 'zuhaus'),
            'font_elegant'      => esc_html__('Font Elegant', 'zuhaus'),
            'ion_icons'         => esc_html__('Ion Icons', 'zuhaus'),
            'simple_line_icons' => esc_html__('Simple Line Icons', 'zuhaus')
        );
        if ($scope == 'regular') {
            $options = array(
                'font_awesome'      => esc_html__('Font Awesome', 'zuhaus'),
                'font_elegant'      => esc_html__('Font Elegant', 'zuhaus'),
                'ion_icons'         => esc_html__('Ion Icons', 'zuhaus'),
                'linea_icons'       => esc_html__('Linea Icons', 'zuhaus'),
                'linear_icons'      => esc_html__('Linear Icons', 'zuhaus'),
                'simple_line_icons' => esc_html__('Simple Line Icons', 'zuhaus'),
                'dripicons'         => esc_html__('Dripicons', 'zuhaus')
            );
        }
        ...
        foreach ($icon_collections as $collection_key => $collection_object) {
            ...
            $mkd_icon_pack_container = zuhaus_mikado_add_admin_container(
                array(
                    'parent'          => $parent,
    ...
    public function getVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false) {
        ...
        $iconPackParams = array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('Icon Pack', 'zuhaus'),
        ...
        if (is_array($this->iconCollections) && count($this->iconCollections)) {
            foreach ($this->iconCollections as $key => $collection) {
                $iconSetParams[] = array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Icon', 'zuhaus'),
    ...
    public function getIconWidgetParamsArray() {
        ...
        $iconPackParams[] = array(
            'type'    => 'dropdown',
            'title'   => esc_html__('Icon Pack', 'zuhaus'),
            'name'    => 'icon_pack',
            'options' => array(
                'font_awesome'      => esc_html__('Font Awesome', 'zuhaus'),
                'font_elegant'      => esc_html__('Font Elegant', 'zuhaus'),
    ...
    public function getIconCollectionIcons(iZuhausMikadoIconCollection $collection) {
...
if (!function_exists('zuhaus_mikado_activate_theme_icons')) {
    function zuhaus_mikado_activate_theme_icons() {
        global $zuhaus_mikado_IconCollections;
        $zuhaus_mikado_IconCollections = ZuhausMikadoIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'zuhaus_mikado_activate_theme_icons');
}