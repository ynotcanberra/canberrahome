...
if ( ! function_exists('zuhaus_mikado_contact_form_7_options_map') ) {

	function zuhaus_mikado_contact_form_7_options_map() {

		zuhaus_mikado_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'zuhaus'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = zuhaus_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'zuhaus')
		));

		//Text Typography

		$typography_text_group = zuhaus_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'zuhaus'),
			'description'	=> esc_html__('Setup typography for form elements text', 'zuhaus'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = zuhaus_mikado_add_admin_row(array(
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'zuhaus'),
		));
		...
		$typography_text_row2 = zuhaus_mikado_add_admin_row(array(
		...
		$typography_text_row3 = zuhaus_mikado_add_admin_row(array(
		...
		$typography_label_group = zuhaus_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'zuhaus'),
			'description'	=> esc_html__('Setup typography for form elements label', 'zuhaus'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = zuhaus_mikado_add_admin_row(array(
		...
		$typography_label_row2 = zuhaus_mikado_add_admin_row(array(
		...
		$background_border_group = zuhaus_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'zuhaus'),
			'description'	=> esc_html__('Setup form elements background and border style', 'zuhaus'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = zuhaus_mikado_add_admin_row(array(
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'zuhaus')
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'zuhaus')
		));

		$background_border_row2 = zuhaus_mikado_add_admin_row(array(
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'zuhaus'),
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'zuhaus')
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'zuhaus')
		));

		$background_border_row3 = zuhaus_mikado_add_admin_row(array(
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'zuhaus'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'zuhaus'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = zuhaus_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'zuhaus'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = zuhaus_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'zuhaus'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'zuhaus'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'zuhaus'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'zuhaus'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = zuhaus_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'zuhaus'),
			'description'	=> esc_html__('Setup form elements margin', 'zuhaus'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = zuhaus_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'zuhaus'),
			'description'	=> esc_html__('Enter height for textarea form element', 'zuhaus'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = zuhaus_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'zuhaus'),
			'description'	=> esc_html__('Setup button text typography', 'zuhaus'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = zuhaus_mikado_add_admin_row(array(
		...
		$button_typography_row2 = zuhaus_mikado_add_admin_row(array(
		...
		$button_background_border_group = zuhaus_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'zuhaus'),
			'description'	=> esc_html__('Setup button background and border style', 'zuhaus'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = zuhaus_mikado_add_admin_row(array(
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'zuhaus')
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'zuhaus')
		));

		$button_background_border_row2 = zuhaus_mikado_add_admin_row(array(
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'zuhaus')
		));
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'zuhaus')
		));

		$button_background_border_row3 = zuhaus_mikado_add_admin_row(array(
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'zuhaus'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		zuhaus_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'zuhaus'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = zuhaus_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'zuhaus')
		));
        ...
        $panel_contact_form_style_3 = zuhaus_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'zuhaus')
        ));
        ...
        $typography_label_row3 = zuhaus_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = zuhaus_mikado_add_admin_row(array(
	...
	add_action( 'zuhaus_mikado_options_map', 'zuhaus_mikado_contact_form_7_options_map', 20);
}