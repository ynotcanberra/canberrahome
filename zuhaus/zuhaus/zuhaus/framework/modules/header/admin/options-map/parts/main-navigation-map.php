...
if ( ! function_exists( 'zuhaus_mikado_get_hide_dep_for_header_main_menu_options' ) ) {
	function zuhaus_mikado_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'zuhaus_mikado_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'zuhaus_mikado_header_main_navigation_options_map' ) ) {
	function zuhaus_mikado_header_main_navigation_options_map() {
		$hide_dep_options = zuhaus_mikado_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = zuhaus_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'zuhaus' ),
		...
		zuhaus_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'zuhaus' )
			)
		);
		
		$drop_down_group = zuhaus_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'zuhaus' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'zuhaus' )
			)
		);
		
		$drop_down_row1 = zuhaus_mikado_add_admin_row(
			array(
		...
		zuhaus_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'zuhaus' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'zuhaus' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'zuhaus' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'zuhaus' )
				)
			)
		);
		...
		$first_level_group = zuhaus_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'zuhaus' )
			)
		);
		...
		zuhaus_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'zuhaus' ),
			)
		);
		...
		zuhaus_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'zuhaus' ),
			)
		);
		
		$first_level_row4 = zuhaus_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		zuhaus_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'zuhaus' ),
			)
		);
		...
		zuhaus_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'zuhaus' ),
			)
		);
		
		$first_level_row5 = zuhaus_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = zuhaus_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = zuhaus_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		zuhaus_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'zuhaus' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		zuhaus_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'zuhaus' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = zuhaus_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'zuhaus' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'zuhaus' )
			)
		);
		...
		zuhaus_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'zuhaus' )
			)
		);
		...
		$second_level_wide_group = zuhaus_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'zuhaus' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'zuhaus' )
			)
		);
		
		$second_level_wide_row1 = zuhaus_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = zuhaus_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = zuhaus_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = zuhaus_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'zuhaus' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'zuhaus' )
			)
		);
		...
		$third_level_row3 = zuhaus_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = zuhaus_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'zuhaus' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'zuhaus' )
			)
		);
		
		$third_level_wide_row1 = zuhaus_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = zuhaus_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = zuhaus_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'zuhaus_mikado_header_main_navigation_options_map', 'zuhaus_mikado_header_main_navigation_options_map', 10, 1 );
}